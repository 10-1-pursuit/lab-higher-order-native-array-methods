...
function findPinkElephantsByTimestreet(songs) {
  ...
  return(songs.find(pinkE => pinkE.title === "Pink Elephants"));
}
...
function findFirstSongUnderThreeMinutes(songs) {
  return(songs.find(underThree => underThree.runtimeInSeconds < 180))
}
...
function findFirstTitleTrack(songs) {
  ...
  return(songs.find(trackTitle => trackTitle.title === trackTitle.album))
}
