 ...
 * @returns {boolean}
 */
function allSongsAreOverTwoMinutes(songs) {return songs.every(song => song.runTimeInSeconds > 120)}
 ...
 * @returns {boolean}
 */
function anySongIsOverFourMinutes(songs) {return songs.some(song => song.runTimeInSeconds > 240)}
 ...
 * @returns {boolean}
 */
function anySongIsByPeanut(songs) {return songs.some(song => song.artist === "Peanut")}
