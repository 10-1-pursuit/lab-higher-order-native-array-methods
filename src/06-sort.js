 ...
 * @returns {Object[]}
 */
//The sort function would not work with the '-' sign, so I found the localeCompare function via https://stackoverflow.com/questions/51165/how-to-sort-strings-in-javascript
function sortByArtistNameDescending(songs) {
  return songs.sort((a, b) => b.artist.toLowerCase().localeCompare(a.artist.toLowerCase()));
}
