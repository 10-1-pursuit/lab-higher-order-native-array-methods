...
function sortByRuntimeAscending(songs) {
  ...
  const runTime= songs.sort((a,b) => a.runtimeInSeconds - b.runtimeInSeconds
  ); 
  return runTime;
  }
...
function sortByArtistNameDescending(songs) {
  const arrangedArtist = songs.sort((a,b) => {
...
function sortBySongTitleAscending(songs) {
  const arrangedArtist1 = songs.sort((a,b) => {
