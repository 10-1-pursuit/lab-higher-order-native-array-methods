 ...
 */
const getSongTitles = (songs) => { return songs.map(songs => songs.title) }
 ...
 */
const getSongDetails = (songs) => { return songs.map(songs => songs.title + " by " + songs.artist) }
 ...
 */
const getTitleAndArtist = (songs) => { return songs.map(songs => ({ [songs.title]: songs.artist })); }
