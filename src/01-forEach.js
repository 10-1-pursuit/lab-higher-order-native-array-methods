...
function printSongTitlesOverThreeMinutes(songs) {
  songs.filter(song => song.runtimeInSeconds > 180).forEach(song => console.log(song.title)) //filter to create new array for runtime>180 - simultaneously log song& title
}
